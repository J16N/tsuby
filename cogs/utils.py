...
class Utils(commands.Cog):
	...
	async def react(self, ctx, *reactions):
		...
		if reactions:
			...
			if reactions: # here the bot will react with custom emotes
				...
				emoji_names = [name for name in reactions if name in emoji_list]
	...
	async def info(self, ctx):
		...
		embed.add_field(name="**Watching Servers**", value=f"{self.bot.guilds}")
		embed.add_field(name="**Uptime**", value=f"{uptime_stamp}")
		embed.add_field(name="**Remark**", value="I am getting smarter everyday. I hope will do the welfare to the mankind soon. <a:tsmileface:581728033967177744:>")
