...
class Utils(commands.Cog):
	...
	@commands.command()
	@commands.cooldown(10,600,type=BucketType.default)
	...
	async def nitromojis(self, ctx):
		...
		embed = discord.Embed(description='***NITROMOJIS***', color=0xFFA200)
	...
	async def react(self, ctx, *reactions):
		...
		if reactions:
			...
			if reactions: # here the bot will react with custom emotes
				...
				emoji_list = [emoji.name for emoji in self.bot.get_guild(372348786917507074).emojis]
