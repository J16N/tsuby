...
class Games(commands.Cog):
	...
	async def help(self, ctx):
		...
		embed.add_field(name="**t-game tictactoe <@user> (optional)**", value="`└─ Starts the tictactoe game. If mentioned user is given then the game will start with that opponent. Else the Tsuby will play. (Note that playing with Tsuby is still in alpha version)`", inline=False)
