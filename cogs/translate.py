...
class Translate(commands.Cog):
	...
	async def help(self, ctx):
		...
		embed.add_field(name="**t-tr fr <dest.> <src> [<user> <user> ... <user>] (Admin-only)**", value="`└─ Auto translates the message to the 'dest.' language from the 'src' language of all the mentioned 'user'`", inline=False)
